...
HD_PWD='D:/Xilinx/BARRLE_SHIFTER/BARRLE_SHIFTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log barrel_org.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source barrel_org.tcl
