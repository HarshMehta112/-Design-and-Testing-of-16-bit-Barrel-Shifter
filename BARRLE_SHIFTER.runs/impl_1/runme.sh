...
HD_PWD='D:/Xilinx/BARRLE_SHIFTER/BARRLE_SHIFTER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log barrel_org.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source barrel_org.tcl -notrace
